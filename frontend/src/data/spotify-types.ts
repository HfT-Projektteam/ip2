...
export interface components {
  schemas: {
    ...
    ArtistObject: {
      ...
      images?: Array<components["schemas"]["ImageObject"]>;
    ...
    QueueObject: {
      ...
      queue?: Array<components["schemas"]["TrackObject"] | components["schemas"]["EpisodeObject"]>;
    };
    ...
    PlayerErrorObject: {
      ...
      /** @description A short description of the cause of the error. */
      message?: string;
      reason?: components["schemas"]["PlayerErrorReasons"];
    };
    /**
    ...
    AudioAnalysisObject: {
      ...
      bars?: Array<components["schemas"]["TimeIntervalObject"]>;
      ...
      beats?: Array<components["schemas"]["TimeIntervalObject"]>;
      ...
      sections?: Array<components["schemas"]["SectionObject"]>;
      /** @description Each segment contains a roughly conisistent sound throughout its duration. */
      segments?: Array<components["schemas"]["SegmentObject"]>;
      ...
      tatums?: Array<components["schemas"]["TimeIntervalObject"]>;
    };
    TimeIntervalObject: {
      /**
    ...
    SimplifiedTrackObject: {
      ...
      artists?: Array<components["schemas"]["SimplifiedArtistObject"]>;
    ...
    DevicesObject: {
      ...
      devices?: Array<components["schemas"]["DeviceObject"]>;
    };
    DeviceObject: {
    ...
    CursorPagingPlayHistoryObject: components["schemas"]["CursorPagingObject"] & {
      items?: Array<components["schemas"]["PlayHistoryObject"]>;
    };
    CursorPagingSimplifiedArtistObject: components["schemas"]["CursorPagingObject"] & {
      items?: Array<components["schemas"]["ArtistObject"]>;
    };
    PagingObject: {
      /**
       * @description A link to the Web API endpoint returning the full result of the request
    ...
    PagingPlaylistObject: components["schemas"]["PagingObject"] & {
      items?: Array<components["schemas"]["SimplifiedPlaylistObject"]>;
    };
    ...
    CategoryObject: {
      ...
      icons: Array<components["schemas"]["ImageObject"]>;
      /**
    ...
    TrackObject: {
      ...
      /** @description The artists who performed the track. Each artist object includes a link in `href` to more detailed information about the artist. */
      artists?: Array<components["schemas"]["ArtistObject"]>;
      /** @description A list of the countries in which the track can be played, identified by their [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code. */
      available_markets?: (string)[];
      /** @description The disc number (usually `1` unless the album consists of more than one disc). */
      disc_number?: number;
    ...
    ShowBase: {
      ...
      copyrights: Array<components["schemas"]["CopyrightObject"]>;
    ...
    AudiobookBase: {
      ...
      authors: Array<components["schemas"]["AuthorObject"]>;
      ...
      narrators: Array<components["schemas"]["NarratorObject"]>;
    ...
    SavedAudiobookObject: {
      ...
      audiobook?: components["schemas"]["AudiobookObject"];
    };
    PagingSavedAudiobookObject: components["schemas"]["PagingObject"] & {
      items?: Array<components["schemas"]["SavedAudiobookObject"]>;
    };
  };
  responses: {
    /**
    ...
    ManyAlbums: {
      content: {
        "application/json": {
          albums: Array<components["schemas"]["AlbumObject"]>;
        };
      };
    };
    ...
    ManyAudiobooks: {
      content: {
        "application/json": {
          audiobooks: Array<components["schemas"]["AudiobookObject"]>;
        };
      };
    };
    ...
    ManyChapters: {
      content: {
        "application/json": {
          chapters: Array<components["schemas"]["ChapterObject"]>;
        };
      };
    };
    ...
    ManyDevices: {
      content: {
        "application/json": components["schemas"]["DevicesObject"];
      };
    };
      ...
      content: {
        "application/json": {
          categories: components["schemas"]["PagingObject"] & {
            items?: Array<components["schemas"]["CategoryObject"]>;
          };
        };
      };
    };
    ...
    ManyAudioFeatures: {
      content: {
        "application/json": {
          audio_features: Array<components["schemas"]["AudioFeaturesObject"]>;
        };
      };
    };
    ...
    ManyEpisodes: {
      content: {
        "application/json": {
          episodes: Array<components["schemas"]["EpisodeObject"]>;
        };
      };
    };
    ...
    ArrayOfImages: {
      content: {
        "application/json": Array<components["schemas"]["ImageObject"]>;
      };
    };
    /** @description A user */
    OnePrivateUser: {
    ...
    ManySimplifiedShows: {
      content: {
        "application/json": {
          shows: Array<components["schemas"]["SimplifiedShowObject"]>;
        };
      };
    };
    ...
    PagingSimplifiedAlbumObject: {
      content: {
        "application/json": components["schemas"]["PagingSimplifiedAlbumObject"];
      };
    };
    /** @description Pages of albums */
    ...
    PagingSimplifiedArtistObject: {
      content: {
        "application/json": components["schemas"]["PagingSimplifiedArtistObject"];
      };
    };
    /** @description Pages of shows */
    PagingSimplifiedShowObject: {
      content: {
        "application/json": components["schemas"]["PagingSimplifiedShowObject"];
      };
    };
    /** @description Pages of shows */
    ...
    OneCurrentlyPlayingTrack: {
      content: {
        "application/json": components["schemas"]["CurrentlyPlayingObject"];
      };
    };
    ...
    PagingArtistObject: {
      content: {
        "application/json": components["schemas"]["PagingArtistObject"];
      };
    };
    /** @description Pages of saved audiobooks */
    PagingSavedAudiobookObject: {
      content: {
        "application/json": components["schemas"]["PagingSavedAudiobookObject"];
      };
    };
    /** @description Pages of tracks */
    PagingTrackObject: {
      content: {
        "application/json": components["schemas"]["PagingTrackObject"];
      };
    };
  };
  parameters: {
